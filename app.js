...
// 环境变量
const UUID = process.env.UUID || '9ac4d3d5-57a7-4ac7-b7df-69099bb39fa8'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const XPATH = process.env.XPATH || 'UgfsTy';                // xhttp路径
const DOMAIN = process.env.DOMAIN || '';                   // 域名或ip,留空将自动获取服务器ip
const NAME = process.env.NAME || 'Vms';                    // 节点名称
